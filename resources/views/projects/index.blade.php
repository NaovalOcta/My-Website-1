...
@section('content')
    <div class="pt-32 pb-20 relative overflow-hidden min-h-screen">
        ...
        <div
            class="absolute top-20 left-1/2 -translate-x-1/2 w-full max-w-4xl h-96 bg-primary/10 rounded-full blur-[120px] -z-10 animate-float">
        </div>
        <div class="absolute bottom-0 right-0 w-80 h-80 bg-purple-600/5 rounded-full blur-[100px] -z-10 animate-float"
            style="animation-delay: 2s;"></div>
        <div class="absolute top-1/2 left-0 w-64 h-64 bg-primary/5 rounded-full blur-[80px] -z-10 animate-float"
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div class="max-w-2xl">
                    <a href="{{ url('/') }}"
                        class="inline-flex items-center gap-2 text-gray-400 hover:text-primary transition mb-4 group animate-fade-in-up">
                ...
                <div class="flex flex-wrap gap-2 animate-fade-in-up" style="animation-delay: 0.3s;">
                    <button
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($projects as $index => $project)
                    ...
                    <a href="{{ route('projects.show', $project->slug) }}"
                        class="group block relative bg-card-bg rounded-3xl overflow-hidden border border-gray-800 hover:border-primary/50 transition duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 animate-fade-in-up"
                        style="animation-delay: {{ 0.1 * ($index % 6) + 0.4 }}s;">
                ...
                @empty
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-3 py-20 animate-fade-in-up"
            ...
            <div class="mt-24 text-center animate-fade-in-up" style="animation-delay: 0.8s;">
