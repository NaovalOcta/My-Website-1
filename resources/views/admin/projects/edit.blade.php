                ...
                <div class="p-5 bg-gray-800/30 rounded-xl border border-gray-700/50 space-y-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="project_type"
                                ...
                                <option value="Personal Project"
                                    {{ old('project_type', $project->project_type) == 'Personal Project' ? 'selected' : '' }}>
                                    Personal Project</option>
                                <option value="Client Project"
                                    {{ old('project_type', $project->project_type) == 'Client Project' ? 'selected' : '' }}>
                                    Client Project</option>
                                <option value="Freelance"
                                    {{ old('project_type', $project->project_type) == 'Freelance' ? 'selected' : '' }}>
                                    Freelance</option>
                                <option value="Open Source"
                                    {{ old('project_type', $project->project_type) == 'Open Source' ? 'selected' : '' }}>
                                    Open Source</option>
                                <option value="Academic"
                                    {{ old('project_type', $project->project_type) == 'Academic' ? 'selected' : '' }}>
                                    Academic</option>
                            </select>
                            @error('project_type')
                                <p class="text-xs text-red-400">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="year" value="{{ old('year', $project->year ?? date('Y')) }}"
                                class="w-full bg-gray-900 border border-gray-700 rounded-md p-2 text-sm text-white focus:border-primary outline-none transition"
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="timeline" value="{{ old('timeline', $project->timeline) }}"
                                class="w-full bg-gray-900 border border-gray-700 rounded-md p-2 text-sm text-white focus:border-primary outline-none transition"
    ...
    <script>
        ...
        function copyIcon(iconClass) {
            navigator.clipboard.writeText(iconClass).then(() => {
                ...
                toast.innerHTML = `<i class="fa-solid fa-check mr-2"></i> Copied: ${iconClass}`;
