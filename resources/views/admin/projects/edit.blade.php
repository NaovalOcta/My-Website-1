...
@section('content')
            ...
            <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-5 bg-gray-800/30 rounded-xl border border-gray-700/50">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="url" name="design_link" value="{{ old('design_link', $project->design_link) }}"
                            class="w-full bg-gray-900 border border-gray-700 rounded-md p-2 text-sm text-white focus:border-primary outline-none transition"
                ...
                <div class="space-y-4">
                            ...
                            <div class="feature-item bg-gray-800/50 rounded-xl p-4 border border-gray-700 relative">
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                                    ...
                                    <div class="md:col-span-3 space-y-1">
                                        ...
                                        <div class="relative">
                                            <span class="absolute left-3 top-2.5 text-gray-500">
                                                <i class="fas fa-star" id="iconPreview0"></i>
                                            </span>
                                            <input type="text" name="features[0][icon]" value="fas fa-star"
                                                class="w-full bg-gray-900 border border-gray-700 rounded-lg pl-10 pr-3 py-2 text-white text-sm focus:border-primary outline-none"
                                                placeholder="fas fa-bolt"
                    ...
                    <div class="bg-gray-900/50 rounded-lg p-3 border border-gray-800">
                        <p class="text-xs text-gray-400 mb-2"><i class="fas fa-lightbulb text-yellow-500 mr-1"></i> Icon
                            Suggestions (click to copy):</p>
                        <div class="flex flex-wrap gap-2">
                            @foreach (['fas fa-bolt', 'fas fa-shield-alt', 'fas fa-rocket', 'fas fa-cog', 'fas fa-code', 'fas fa-database', 'fas fa-cloud', 'fas fa-lock', 'fas fa-chart-line', 'fas fa-mobile-alt', 'fas fa-palette', 'fas fa-globe'] as $icon)
    ...
    <script>
            ...
            div.innerHTML = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                    <div class="md:col-span-3 space-y-1">
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2.5 text-gray-500">
                                <i class="fas fa-star" id="iconPreview${featureCount}"></i>
                            </span>
                            <input type="text" name="features[${featureCount}][icon]" value="fas fa-star"
                                class="w-full bg-gray-900 border border-gray-700 rounded-lg pl-10 pr-3 py-2 text-white text-sm focus:border-primary outline-none"
                                placeholder="fas fa-bolt"
        ...
        function updateIconPreview(input, previewId) {
            ...
            if (preview) {
                preview.className = input.value || 'fas fa-star';
            }
        }
                    ...
                    reader.onload = function(e) {
                        ...
                        imgWrapper.innerHTML = `
                            <img src="${e.target.result}" alt="Gallery ${index + 1}"
                                class="h-20 w-20 object-cover rounded-lg border border-green-500/50">
                            <span class="absolute -top-1 -right-1 bg-green-600 text-xs text-white rounded-full w-5 h-5 flex items-center justify-center">
                                ${index + 1}
                            </span>
                        `;
